...
export const products: Product[] = [
  {
    id: "hp-e47528f",
    model: "E47528f",
    name: "HP Color LaserJet Enterprise MFP E47528f",
    format: "A4",
    color: true,
    speed: 27,
    volumeMin: 1000,
    ...
    description:
      "Compact A4 colour MFP ideal for small workgroups. Delivers reliable performance with low running costs.",
    features: [
  ...
  },
  {
    ...
    description:
      "Versatile A3 colour MFP with advanced workflow features. Perfect balance of capability and efficiency.",
    features: [
  ...
  },
  {
    ...
    idealFor: "Busy teams",
    description:
      "High-performance A3 colour MFP designed for demanding workgroups. Fast, reliable, and feature-rich.",
    features: [
  ...
  },
  {
    ...
    description:
      "Enterprise-grade A3 colour MFP for high-demand environments. Exceptional speed meets professional quality.",
    features: [
  ...
  },
  {
    id: "hp-e87750dn",
    model: "E87750dn",
    name: "HP Color LaserJet Enterprise Flow MFP E87750dn",
    format: "A3",
    color: true,
    speed: 50,
    volumeMin: 20000,
    ...
    description:
      "Production-level A3 colour MFP for the most demanding enterprise environments. Maximum throughput and reliability.",
    features: [
